...
const ChatUpTandC = () => {
  return (
    <div className="privacy-container">
      ...
      <ul>
        <li>
          <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Chat Up</p>
        </li>
        <li>
