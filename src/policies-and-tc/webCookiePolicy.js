  ...
  return (
    <div className="privacy-container">
      ...
      <ul>
        ...
        <li><strong>Website</strong> refers to NoCorps, accessible from <a href="https://nocorps.org/" rel="external nofollow noopener" target="_blank">https://nocorps.org/</a></li>
...
export default WebCookiePolicy;
